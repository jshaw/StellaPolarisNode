...
// This logic can be used to ignore certain devices that are discovered within a set time after starting.
// It'll be like an ignore list
// =====
...
function initBleacon(){

  Bleacon.on('discover', function(bleacon) {

    console.log('BLEACON: ' + bleacon);
    console.log('BLEACON JSON:' + JSON.stringify(bleacon));
